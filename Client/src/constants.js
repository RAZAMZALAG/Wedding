...
export const EP_ADD_ITEM = API + "/items/add";
...
export const EP_PERSONAL_BOOKINGS = EP_BOOKINGS + "my-bookings";
...
export const EP_LOCK_ITEMS = EP_BOOKINGS + "lock-items";
export const EP_EXTEND_LOCKS = EP_BOOKINGS + "extend-locks";
export const EP_RELEASE_LOCKS = EP_BOOKINGS + "release-locks";
export const EP_CHECK_AVAILABILITY = EP_BOOKINGS + "check-availability";
export const EP_AVAILABLE_DATE_RANGES = EP_BOOKINGS + "available-date-ranges";
export const EP_CHECK_DATE_RANGE = EP_BOOKINGS + "check-date-range";
export const EP_USERS = API + "/users/";
export const EP_USERS_UPDATE = EP_USERS + "update/";
export const EP_USERS_BLOCK = EP_USERS;  // Will be used as EP_USERS_BLOCK + user_id + "/block"
export const EP_USERS_UNBLOCK = EP_USERS;  // Will be used as EP_USERS_UNBLOCK + user_id + "/unblock"
